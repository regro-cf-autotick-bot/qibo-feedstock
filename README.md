...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/qibo-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14110&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/qibo-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `qibo` can be installed with:

```
conda install qibo
```

It is possible to list all of the versions of `qibo` available on your platform with:
